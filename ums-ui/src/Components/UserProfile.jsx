  ...
  return (
      <div
        ...
        <div className="flex justify-between items-center">
          <p className="font-semibold text-lg dark:text-gray-200">User
            Profile</p>
          <Button
        ...
        <div
          ...
          />
          <div>
            <p className="font-semibold text-xl dark:text-gray-200"> {userData.given_name} {userData.family_name} </p>
            <p className="text-gray-500 text-sm dark:text-gray-400">
              {userData.is_student ? 'STUDENT' : 'ADMIN'} </p>
